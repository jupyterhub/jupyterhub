...
To set anything complex other than string please look at `auth_state_hook` available in most of the spawners which can read the entire `auth_state` dictionary. 
