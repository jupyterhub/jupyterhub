...
project = 'JupyterHub'
copyright = '2015, The Jupyter Team'
...
# Jupyter docs use the following (thanks minrk) code to autogenerate versions
...
latex_documents = [
  (master_doc, 'JupyterHub.tex', 'JupyterHub Documentation',
   'The Jupyter Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'jupyterhub', 'JupyterHub Documentation',
     [author], 1)
]
