...
def upgrade():
    ...
    try:
        ...
        print("The properties column could not have been added. Perhaps because it is already existing.")
...
def downgrade():
    ...
    try:
        ...
        print("The properties column could not have been removed. Perhaps because it is not existing.")
    # ### end Alembic commands ###
